...
const RegisterRoomPublicBedTypes: React.FC = () => {
  ...
  const [activeBedOption, setActiveBedOption] = useState<BedType[]>(
    initialBedOptions,
  )

  const lastBedOptions = useMemo(() => {
    return bedTypes.filter((bedType) => !activeBedOption.includes(bedType));
  }, [activeBedOption, publicBedList]);
